...
#[allow(unused_macros)]
#[doc(hidden)]
macro_rules! __export_auth_api_impl {
    ($ty:ident) => {
...
#[doc(inline)]
pub(crate) use __export_auth_api_impl as export;
#[cfg(target_arch = "wasm32")]
#[unsafe(link_section = "component-type:wit-bindgen:0.41.0:mik:auth-api@0.1.0:auth-api:encoded world")]
#[doc(hidden)]
#[allow(clippy::octal_escapes)]
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 1923] = *b"\
...
\x0a\x04\0\x16mik:core/handler@0.1.0\x05\x0a\x04\0\x1bmik:auth-api/auth-api@0.1.\
0\x04\0\x0b\x0e\x01\0\x08auth-api\x03\0\0\0G\x09producers\x01\x0cprocessed-by\x02\
