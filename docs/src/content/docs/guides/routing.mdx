...
- OpenAPI schema generation (`/__schema` endpoint)
- Documentation

<Aside type="note">
Response types are optional and don't affect runtime behavior. The actual response is determined by what your handler returns.
</Aside>
...
The `routes!` macro automatically registers:

| Endpoint | Description |
|----------|-------------|
| `/__schema` | OpenAPI JSON schema |
